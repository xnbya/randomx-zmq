...
static void * worker_routine(void * wid)
{
    ...
    randomx_flags flags = RANDOMX_FLAG_JIT | RANDOMX_FLAG_HARD_AES | RANDOMX_FLAG_FULL_MEM | RANDOMX_FLAG_LARGE_PAGES;
...
{    
    ...
    zsock_t *worker2 = zsock_new_dealer("@inproc://worker2");
    ...
    pthread_create(&threads[2], NULL, worker_routine, ">inproc://worker2");
    ...
    void *worker2_s = zsock_resolve(worker2);
